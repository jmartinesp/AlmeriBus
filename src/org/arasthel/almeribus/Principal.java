		...
		protected void onPostExecute(Boolean result) {
			...
			if(result) {
				if(necesitaActualizacion) {
					...
					Toast.makeText(Principal.this, "Información de las líneas cargada", Toast.LENGTH_SHORT).show();
				}
				...
				if(mantenimiento) {
					...
					alertBuilder.setMessage("Parece que la página de \"Tiempos de espera\" de la web móvil de Surbus no funciona, es muy posible que la aplicación no funcione totalmente debido a esto.\n\nSi quiere, puede enviarles un correo para preguntarles qué ocurre. Puede ayudar a que el problema se solucione antes.");
					alertBuilder.setPositiveButton("Enviar correo", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface arg0, int arg1) {
							...
							try{
								...
								builder.setMessage("No tiene clientes de correo electrónico instalados. El correo de Surbus es:\ninfo@surbus.com");
				...
				if(Principal.this != null) {
					...
					try {
						...
						if(version > currentVersion) {
							AlertDialog.Builder builder = new Builder(Principal.this);
							builder.setTitle("Hay una actualización de la aplicación");
							builder.setMessage("Hay una nueva versión de la aplicación, es aconsejable que la instale para asegurar un buen funcionamiento");
